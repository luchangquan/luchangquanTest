...
import com.renke.rdbao.daos.rdbao_v3.dao.mapper.IAppsMapper;
 ...
 */
@Repository
public class AppsDao extends BaseDao<Apps> implements IAppsDao {
	@Autowired
	private IAppsMapper appsMapper;
