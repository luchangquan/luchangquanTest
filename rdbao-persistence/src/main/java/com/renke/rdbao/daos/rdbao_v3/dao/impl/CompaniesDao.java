...
import com.renke.rdbao.daos.rdbao_v3.dao.mapper.ICompaniesMapper;
 ...
 */
@Repository
public class CompaniesDao extends BaseDao<Companies> implements ICompaniesDao {
	@Autowired
	private ICompaniesMapper companiesMapper;
