 ...
 * @version 1.0
 */
public class EvidenceAppVideoService extends BaseService<EvidenceAppVideo> implements IEvidenceAppVideoService {
	private static final Logger _LOGGER = LoggerFactory.getLogger(EvidenceAppVideoService.class);
