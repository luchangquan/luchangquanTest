...
public interface IAppNoticeService {
	 ...
	 * @throws DecoderException
	 */
	void saveAudioNotice(RequestSignData requestSignData, UserContext userContext) throws InvalidKeyException, NoSuchAlgorithmException, SignatureException, UserContextException, AliOperateException,
			DecoderException;
	 ...
	 * @throws DecoderException
	 */
	void savePictureNotice(RequestSignData requestSignData, UserContext userContext) throws InvalidKeyException, NoSuchAlgorithmException, SignatureException, UserContextException,
