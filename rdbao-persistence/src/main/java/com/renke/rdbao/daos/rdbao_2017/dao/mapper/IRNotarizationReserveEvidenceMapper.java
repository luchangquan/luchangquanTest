 ...
 * @version 1.0
 */
public interface IRNotarizationReserveEvidenceMapper extends Mapper<RNotarizationReserveEvidence>, MySqlMapper<RNotarizationReserveEvidence>,
		InsertListNotUseGeneratedKeyMapper<RNotarizationReserveEvidence> {
