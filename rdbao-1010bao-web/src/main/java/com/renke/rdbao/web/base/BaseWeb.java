...
public class BaseWeb {
	 ...
	 * @throws UserContextException
	 */
	public UserContext getUserContext(String accessToken) throws UserContextException {
		UserContext userContext = userContextService.getUserContextByAccessToken(accessToken);
		return userContext;
	}
