...
<head>
    ...
    <title>${param.tip }重置密码-通话录音保全存证工具</title>
...
<div class="login">
    <div class="loginheader">
        ...
        <span class="pagetitle">${param.tip }重置密码</span>
				 			 ...
				 			 var reType= $("input[name='reType']:checked").val();
                           	 ...
                           	 if(reType==1){
                    	         ...
                    	         var url="${baseUrl}/login/sendVerificationCode";
                               	 var data={"account":userIdin,"userType":recoveryin,"smsTemplateCode":"SMS_56120044"};
                               	 $.ajax({
                               		url: url, 
                               		data:data,
                               		type:"POST",
                    	         ...
                    	         var url="${baseUrl}/login/sendVerificationMailCode";
                               	 var data={"targetEmail":targetEmail,"userType":recoveryin,"smsTemplateCode":"modify_password_code"};
                               	 $.ajax({
                               		url: url, 
                               		data:data,
                               		type:"POST",
