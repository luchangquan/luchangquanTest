...
public class VoiceStatisticsSupport {
	 ...
	 */
	public void downloadVoiceRecording(List<EnhancedMEvidenceTelecomVoice> enhancedEvidenceFaxVoices, HttpServletResponse response) throws UnsupportedEncodingException {
	...
	private void appendSheetInfoForVoiceRecording(HSSFWorkbook workbook, HSSFSheet sheet, List<String> titles, List<EnhancedMEvidenceTelecomVoice> enhancedEvidenceFaxVoices) {
		...
		for (int i = 0; i < enhancedEvidenceFaxVoices.size(); i++) {
			...
			EnhancedMEvidenceTelecomVoice _EnhancedMEvidenceTelecomVoice = enhancedEvidenceFaxVoices.get(i);
			...
			callTypeCell.setCellValue(_EnhancedMEvidenceTelecomVoice.getCallType().getDesc());

			callingPhoneNoCell.setCellType(Cell.CELL_TYPE_STRING);
			callingPhoneNoCell.setCellValue(_EnhancedMEvidenceTelecomVoice.getCallingNo());

			calledPhoneNoCell.setCellType(Cell.CELL_TYPE_STRING);
			calledPhoneNoCell.setCellValue(_EnhancedMEvidenceTelecomVoice.getCalledNo());

			startTimeCell.setCellType(Cell.CELL_TYPE_STRING);
			startTimeCell.setCellValue(new DateTime(_EnhancedMEvidenceTelecomVoice.getCallTime()).toString("yyyy-MM-dd HH:mm:ss"));

			endTimeCell.setCellType(Cell.CELL_TYPE_STRING);
			endTimeCell.setCellValue(new DateTime(_EnhancedMEvidenceTelecomVoice.getCallTime()).plusSeconds((int) _EnhancedMEvidenceTelecomVoice.getDuration()).toString("yyyy-MM-dd HH:mm:ss"));

			durationCell.setCellType(Cell.CELL_TYPE_NUMERIC);
			durationCell.setCellValue(_EnhancedMEvidenceTelecomVoice.getDuration());
