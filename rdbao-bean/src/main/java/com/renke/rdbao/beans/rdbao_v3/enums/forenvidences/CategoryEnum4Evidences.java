 ...
 * @version 1.0
 */
public enum CategoryEnum4Evidences {
	...
	private CategoryEnum4Evidences(short code, String desc) {
		this.code = code;
		this.desc = desc;
	}
	...
	public static CategoryEnum4Evidences getCategoryEnumByCode(short code) {
		for (CategoryEnum4Evidences _Enum : CategoryEnum4Evidences.values()) {
