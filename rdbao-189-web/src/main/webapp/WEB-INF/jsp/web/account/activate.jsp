...
<head>
    ...
    <title>账户激活-通话录音保全存证工具</title>
     <link href="${baseUrl}/resources/css/login/login.css?ver=201" rel="stylesheet">
...
<div class="login">
    <div class="loginheader">
        ...
        <span class="pagetitle">账户激活</span>
    ...
    <div class="recovery">
        ...
        <div class="recovery02">
            ...
            <ul>
                ...
                <li class="reType paddLf10"><i>激活方式</i>
...
<!--                     <b class="userType">若忘记手机或邮箱，请联系贵公司的管理人员账户激活。</b>成员 -->
                    <b class="userTis">很遗憾，您未设置任何密码保护措施，无法通过系统账户激活。<br/>请联系贵公司的管理人员账户激活。</b><!--成员没有绑定手机-->
                </li>
            </ul>
        </div>
        ...
        <div class="recovery05">
            <div>恭喜您，账户激活成功！返回<a href="${baseUrl}/login/logout">重新登录</a></div>
        </div>
                           	 ...
                           	 $.ajax({
                           		...
                           		success: function(result){
                           			if(result.success==false){
                           				...
                           				var data={"userType":recoveryin,"account":userIdin,"opType":"2"};
                                      	 $.ajax({
                                        		url: url, 
                                        		data:data,
                                        		type:"POST",
				 			 ...
				 			 var reType= $("input[name='reType']:checked").val();
                           	 ...
                           	 if(reType==1){
                    	         ...
                    	         var url="${baseUrl}/login/sendVerificationCode";
                               	 var data={"account":userIdin,"userType":recoveryin,"smsTemplateCode":"SMS_56010067"};
                               	 $.ajax({
                               		url: url, 
                               		data:data,
                               		type:"POST",
                    	         ...
                    	         var url="${baseUrl}/login/sendVerificationMailCode";
                               	 var data={"targetEmail":targetEmail,"userType":recoveryin,"smsTemplateCode":"active_account_code"};
                               	 $.ajax({
                               		url: url, 
                               		data:data,
                               		type:"POST",
