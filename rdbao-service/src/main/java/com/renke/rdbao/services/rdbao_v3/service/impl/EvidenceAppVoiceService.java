 ...
 * @version 1.0
 */
public class EvidenceAppVoiceService extends BaseService<EvidenceAppVoice> implements IEvidenceAppVoiceService {
	private static final Logger _LOGGER = LoggerFactory.getLogger(EvidenceAppVoiceService.class);
