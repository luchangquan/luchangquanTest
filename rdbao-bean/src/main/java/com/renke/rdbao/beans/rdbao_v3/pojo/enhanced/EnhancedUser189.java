 ...
 * @version 1.0
 */
public class EnhancedUser189 extends BaseEnhanced {
	public EnhancedUser189() {
	}

	public EnhancedUser189(User189 user189) {
		...
		if (user189.getCompanyId() != null && user189.getCompanyId().trim().length() > 0) {
			...
			_EnhancedCompanies.setId(user189.getCompanyId());
