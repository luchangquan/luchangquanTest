...
public class EvidencesFaxVoiceServiceTest {

	private Logger _Logger = org.slf4j.LoggerFactory.getLogger(EvidencesFaxVoiceServiceTest.class);
	...
	public void test() throws UserContextException {
		...
		_Logger.info(JSONObject.toJSONString(evidenceFaxVoicesService.getPagination(null, null, "02169765392", new Pagination(1, 10, true), userContext)));
