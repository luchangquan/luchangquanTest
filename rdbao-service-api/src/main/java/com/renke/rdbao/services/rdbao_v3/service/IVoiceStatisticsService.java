...
public interface IVoiceStatisticsService {
	 ...
	 * @throws UserContextException
	 */
	VoiceCycleDateStatisticsVo getVoiceCycleDateStatistics(Date startTime, Date endTime, String searchPhoneNoOrNickname, List<CallTypeEnum4EvidenceFaxVoices> callTypes, Pagination pagination,
	 ...
	 * @throws UserContextException
	 */
	TotalVoiceCycleDateQuantityStatisticsVo getTotalVoiceCycleDateQuantityStatisticsVo(Date startTime, Date endTime, String searchPhoneNoOrNickname, List<CallTypeEnum4EvidenceFaxVoices> callTypes,
	 ...
	 * @throws UserContextException
	 */
	VoiceSpecifiedDateStatisticsVo getVoiceSpecifiedDateStatistics(Date startTime, Date endTime, String searchPhoneNoOrNickname, List<CallTypeEnum4EvidenceFaxVoices> callTypes, UserContext userContext);
	 ...
	 * @return
	 */
	TotalVoiceSpecifiedDateQuantityStatisticsVo getTotalVoiceSpecifiedDateQuantityStatistics(Date curTime, String searchPhoneNoOrNickname, List<CallTypeEnum4EvidenceFaxVoices> callTypes,
			UserContext userContext);
}
