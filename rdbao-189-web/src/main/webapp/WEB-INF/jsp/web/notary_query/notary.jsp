...
<section class="main">
    <div class="main-left">
        <ul class="navLF">
            ...
            <li><a href="${baseUrl}/notaryQuery/notaryList?states=1">申请中</a></li>
            <li><a href="${baseUrl}/notaryQuery/notaryList?states=2">预约成功</a></li>
            <li><a href="${baseUrl}/notaryQuery/notaryList?states=3">预约失败</a></li>
...
<script type="text/javascript">
	...
	//根据状态来控制 菜单样式
		...
		if(states=="null"||states==""){
			...
			$(".navLF").find("li").eq(3).attr("class","currentlt");
		}else if(states=="5"){
			$(".navLF").find("li").eq(4).attr("class","currentlt");
		}
